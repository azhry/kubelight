...
export function LogViewer({ logs, streaming, onStart, onStop, onClear }: LogViewerProps) {
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between h-10 px-4 border-b border-outline-variant bg-surface-container-low shrink-0">
        <div className="flex items-center gap-6 h-full">
          <button className="h-full flex items-center gap-2 font-label-sm text-label-sm text-primary border-b-2 border-primary">
            <ScrollText className="h-4 w-4" />
            Logs
          </button>
          <button className="h-full flex items-center gap-2 font-label-sm text-label-sm text-on-surface-variant hover:text-on-surface transition-colors">
